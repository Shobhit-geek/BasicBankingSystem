    ...
    <div class="container-fluid">
        <div class="row haa" style="font-family:'DM Sans', sans-serif;">
            ...
            <div class="row" style="margin-top: 50px;">
                ...
                <div class="col-sm-8" style="border: 2px solid white;border-radius:5px;">
                    <?php
                    $var1=$_GET['id'];
            ...
            <div class="row"
                style="margin-top: 240px;font-family:'DM Sans', sans-serif;background-color: rgb(61, 59, 59);color: aliceblue;">
