            ...
            <div class="col-sm-8">
                ...
                if(mysqli_affected_rows($link)>0 )
                {
                    echo "<table class='table table-stripped' style='color:white'>";
                        echo "<tr><th>S.NO.</th><th>Name</th><th>EmailID</th><th>Balance</th><th></th></tr>";
                    ...
                    while($r=mysqli_fetch_array($rs))
                    {
                        echo "<tr>";
                            ...
                            echo "<td>$r[2]</td>";
                            echo "<td>$r[4]</td>";
                            echo "<td><a href='./view2.php?id=$r[0]'><button type='button' class='btn-btn-success' style='background-color: aquamarine;'>View</button></a></td>";
                        echo "</tr>";
                }
                echo "</table>";
                }
