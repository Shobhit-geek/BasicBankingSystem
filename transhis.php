...
<body>
    <div class="container-fluid">
        <div class="row haa" style="font-family:'DM Sans', sans-serif;">
            ...
            <h2 class="t1">Transaction History</h2>
            <div class="col-sm-1"></div>
            <div class="col-sm-10">
                <?php
                include_once './dbconn.php';
                $qs="select * from transaction";
                $rs=mysqli_query($link,$qs);
                if(mysqli_affected_rows($link)>0 )
                {
                    echo "<table class='table table-stripped' style='color:white'>";
                        echo "<tr><th>S.NO.</th><th>Sender's Name</th>
                        <th>Sender's A/C No.</th><th>Receiver's Name</th><th>Receiver's A/C No.</th>
                        <th>Amount</th><th>Date & Time</th></tr>";
